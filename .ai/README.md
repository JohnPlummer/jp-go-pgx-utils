...
Progressive loading documentation system for jp-go-pgx-utils package.
...
- Specific to jp-go-pgx-utils package only
...
3. Load specific files based on current task:
   ...
   - Database patterns → `common/standards/database/`
...
- Usage guide: `common/standards/go/jp-go-pgx-utils.md` (how to USE this package)
